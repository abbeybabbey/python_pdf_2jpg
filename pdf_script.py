...
for page in pages:
    ...
    #we save the page as jpeg, we use literal string interpolation ("f" symbol in front the string) so we can enter the variable inside {}
    page.save(f'output\{jpeg_file}', 'JPEG')